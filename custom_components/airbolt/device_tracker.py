...
class LocationTracker(CoordinatorEntity, TrackerEntity):
    ...
    def name(self) -> str | None:
        """Return a friendly name for this tracker entity."""
    ...
    def device_type(self) -> str:
        """Return the device type of the tracker."""
        return self._tracker.device_type

    @property
    def operating_mode(self) -> str:
        """Return the operating mode of the tracker."""
        return self._tracker.operating_mode

    @property
    def modem_voltage(self) -> int | None:
        """Return the modem voltage of the tracker."""
        return self._tracker.modem_voltage

    @property
    def reporting_interval(self) -> int:
        """Return the reporting interval of the tracker."""
